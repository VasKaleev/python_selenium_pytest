...
#elem = driver.find_element(By.CLASS_NAME, ".search-input input")
#elem.send_keys('test')
#print(elem.text)
#time.sleep(2)
...
driver.get("https://www.mvideo.ru")
time.sleep(5)
tv = driver.find_elements(By.CSS_SELECTOR, "div.bottom-navbar-link:nth-child(3) > a:nth-child(1)")
print(*tv,sep="\n")
time.sleep(3)
...
#elems = driver.find_elements(By.CSS_SELECTOR, "a.product-title__text")
for elem in elems:
    print(elem.text)
time.sleep(3) 
#print(*elems, sep='\n')
